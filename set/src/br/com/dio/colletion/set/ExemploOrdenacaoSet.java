...
Série 1 = Nome: RaM, genero: animacao, tempoEpisodio: 25
Série 2 = nome: simpsons, genero: comedia, tempoEpisodio: 40
Série 3 = nome: the las of us, genero: drama, tempoEpisodio:50
*/
...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<>(){{
            add(new Serie("R&M", "animação", 20));
            add(new Serie("Simpsons", "comédia", 40));
            add(new Serie("The las of Us", "drama", 60));
        }};
        ...
        Set<Serie> minhasSeries1 = new LinkedHashSet<>() {{
            add(new Serie("R&M", "animação", 20));
            add(new Serie("Simpsons", "comédia", 40));
            add(new Serie("The las of Us", "drama", 40));
        }};
